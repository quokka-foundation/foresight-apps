...
import { MOCK_MARKETS, MOCK_PORTFOLIO, formatUSD, formatPercent } from '@/lib/mock-data';
...
const FILTER_CHIPS = ['All Markets', 'Trending', 'Crypto', 'Politics', 'Sports'];
...
export default function HomePage() {
  ...
  const filteredMarkets = useMemo(() => {
    ...
    if (activeTab !== 'trending' && activeTab !== 'new' && activeTab !== 'all') {
      ...
      <div className="flex flex-col min-h-screen max-w-[430px] mx-auto bg-white">
        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-lg safe-area-top border-b border-base-gray-50">
          <div className="px-5 pt-5 pb-3">
            ...
            <div className="flex items-center gap-3 mb-5">
              <button className="p-1 text-illoblack hover:opacity-60 transition-opacity" aria-label="Menu">
              ...
              <button className="p-1 text-base-gray-200 hover:text-illoblack transition-colors" aria-label="Info">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
        ...
        >
          <motion.div variants={itemVariants}>
            <Text variant={TextVariant.CaptionMono} className="text-base-gray-200 mb-1">
              Portfolio Value
            </Text>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex gap-6 mt-5">
            <div>
              ...
              <Text variant={TextVariant.BodyMono} className="text-illoblack mt-0.5">
        ...
        >
          ...
          {featuredMarket && (
            <motion.div variants={itemVariants} className="mb-5">
              ...
              >
                <MarketCard market={featuredMarket} index={0} variant="featured" />
              </InteractiveCard>
            </motion.div>
          )}
