...
interface StatusBadgeProps {
  ...
  glow?: boolean;
  /** Use on-dark styling (for dark signal cards) */
  onDark?: boolean;
}
...
const variantColors = {
  green: {
    ...
    text: "text-ios-green",
    dot: "bg-ios-green",
    bgDark: "bg-ios-green/25",
    textDark: "text-ios-green",
  },
  blue: {
    bg: "bg-ios-blue/15",
    text: "text-ios-blue",
    dot: "bg-ios-blue",
    bgDark: "bg-ios-blue/25",
    textDark: "text-ios-blue",
  },
  red: {
    bg: "bg-ios-red/15",
    text: "text-ios-red",
    dot: "bg-ios-red",
    bgDark: "bg-ios-red/25",
    textDark: "text-ios-red",
  },
  orange: {
    bg: "bg-ios-orange/15",
    text: "text-ios-orange",
    dot: "bg-ios-orange",
    bgDark: "bg-ios-orange/25",
    textDark: "text-ios-orange",
  },
  purple: {
    bg: "bg-ios-purple/15",
    text: "text-ios-purple",
    dot: "bg-ios-purple",
    bgDark: "bg-ios-purple/25",
    textDark: "text-ios-purple",
  },
};
...
export function StatusBadge({
  ...
  return (
    ...
    >
      {pulse && (
        <span
          className={`w-1.5 h-1.5 rounded-full ${colors.dot} animate-pulse ${glow ? "dot-glow" : ""}`}
        />
      )}
      {label}
    </span>
