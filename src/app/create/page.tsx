      ...
      <div className="flex-1 px-5 pb-24">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Title level={TitleLevel.H3Medium} className="text-illoblack mb-2">
              Create a Curve Market
            </Title>
          </motion.div>
          <motion.div variants={itemVariants}>
            <Text
              variant={TextVariant.Body}
              className="text-base-gray-200 max-w-[300px] mx-auto leading-relaxed"
            >
              Launch a continuous outcome market for any real-world event. Markets go live instantly
              on Base.
            </Text>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="pt-2">
            <PillCTA label="Launch via Frame" variant="blue" disabled />
        ...
        >
          ...
          <Text variant={TextVariant.Body} className="text-white/70 leading-relaxed">
            Share your market as a Farcaster Frame for maximum reach. Cast your market URL to let
            anyone trade directly from their feed.
          </Text>
