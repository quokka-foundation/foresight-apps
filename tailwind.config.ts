    ...
    extend: {
      colors: {
        ...
        foresight: {
          ...
          warning: "#FF9F0A",
          "card-dark": "#0D1018",
          "card-dark-inner": "#141822",
          "card-dark-border": "#1C2538",
          "card-dark-border-light": "#243048",
        },
        politics: "#FF6B6B",
        crypto: "#0052FF",
        economics: "#FF9F0A",
      ...
      boxShadow: {
        ...
        "card-row": "0 1px 0 0 rgba(255,255,255,0.04)",
        "card-hover": "0 4px 24px rgba(0, 0, 0, 0.6)",
        "card-lg": "0 8px 32px rgba(0, 0, 0, 0.5)",
        "blue-glow": "0 0 20px rgba(0, 82, 255, 0.35), 0 4px 20px rgba(0, 82, 255, 0.2)",
        "green-glow": "0 0 20px rgba(0, 211, 149, 0.35), 0 4px 20px rgba(0, 211, 149, 0.2)",
        "tab-active": "0 0 12px rgba(0, 82, 255, 0.5)",
      },
    },
  },
